...
public class CityVisitController {
    ...
    public ResponseEntity<CommonResponse<CityVisitResponseDto>> handleCityVisitRegister(
        ...
        return ResponseEntity.ok(new CommonResponse<>(
                ResponseStatuses.SUCCESS, CityVisitResponseDto.convert(visited)));
    }

    // 도시 방문 기간(시작-종료 일자) 수정
    @PatchMapping("/api/city-visit")
    public ResponseEntity<CommonResponse<CityVisitResponseDto>> handleCityVisitModify(
        ...
        return ResponseEntity.ok(new CommonResponse<>(
                ResponseStatuses.SUCCESS, CityVisitResponseDto.convert(modified)));
    }

    // 도시 방문 순서 재정렬
    @PatchMapping("/api/city-visit/order")
    public ResponseEntity<CommonResponse<Object>> handleCityVisitOrderRealign(
        ...
        return ResponseEntity.ok(new CommonResponse<>(ResponseStatuses.SUCCESS, null));
    }
